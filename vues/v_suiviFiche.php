<div id="contenu">
    ...
    <form action="index.php?uc=suivreFrais&action=valideChoixFiche" method="post">
        <div class="corpsForm">
            ...
            <p>
                ...
                <?php
                        ...
                        foreach($listeFichesFrais as $data) 
                        {
                                ...
                                //$v_moisF = explode(2, $v_mois);
                                
                                //l'id de l'option est : mois + id
                                //ce format sera ensuite découpé par la suite.
                                //afin d'obtenir le mois et l'id séparément
                ?> 
                <option value="<?php echo $v_mois.$v_id; ?>"> <?php echo "Fiche du visiteur: ".$v_nom." ".$v_prenom." | Mois (aaaamm): ".$v_mois." | Montant validé: ".$v_montant."€"; ?> </option>
                <?php
                        }
                ?>
                </select>
